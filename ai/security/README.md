...
> **Section:** `ai/` | **Subsection:** `security/`  
...
Prompt injection, jailbreak prevention, model inversion, supply chain attacks, and AI red teaming.
...
### 1. Intentional Design for AI Security
...
### RAG Integration for AI Security
...
*Section: `ai/security/` | Aligned to TOGAF · NIST · ISO 27001 · AWS Well-Architected*
