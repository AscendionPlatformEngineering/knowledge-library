...
cat > "$PREVIEW/forty-six-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Forty-six pages, forty-six motion mechanics — Review Checklists group complete</h1>
...
add_card() {
  ...
  } >> "$PREVIEW/forty-six-emblems.html"
}
...
# ─── v34 cleanup script (deletes orphan stub directories from user's repo) ───
cat > "$REPO/tools/CLEANUP_v34.sh" <<'CLEANUP_EOF'
#!/usr/bin/env bash
...
CLEANUP_EOF
chmod +x "$REPO/tools/CLEANUP_v34.sh"

tar czf "$OUT/ascendion-engineering-v34.tar.gz" \
    --exclude='.git' --exclude='node_modules' --exclude='*.pyc' \
    tools src content infra .github

# Also expose CLEANUP_v34.sh as a standalone output (user can run it before
# extracting the tarball, without having to extract the tarball first).
cp "$REPO/tools/CLEANUP_v34.sh" "$OUT/CLEANUP_v34.sh"

# AI-Native preview copies
cp "$PREVIEW/ai-native-architecture-preview.html" "$OUT/ai-native-architecture-preview-v34.html"
cp "$PREVIEW/ai-native-ethics-preview.html"       "$OUT/ai-native-ethics-preview-v34.html"
cp "$PREVIEW/ai-native-monitoring-preview.html"   "$OUT/ai-native-monitoring-preview-v34.html"
cp "$PREVIEW/ai-native-rag-preview.html"          "$OUT/ai-native-rag-preview-v34.html"
cp "$PREVIEW/ai-native-security-preview.html"     "$OUT/ai-native-security-preview-v34.html"

# Governance preview copies (v34)
cp "$PREVIEW/governance-checklists-preview.html"        "$OUT/governance-checklists-preview-v34.html"
cp "$PREVIEW/governance-review-templates-preview.html"  "$OUT/governance-review-templates-preview-v34.html"
cp "$PREVIEW/governance-roles-preview.html"             "$OUT/governance-roles-preview-v34.html"
cp "$PREVIEW/governance-scorecards-preview.html"        "$OUT/governance-scorecards-preview-v34.html"

# Observability preview copies (v34)
cp "$PREVIEW/observability-incident-response-preview.html"  "$OUT/observability-incident-response-preview-v34.html"
cp "$PREVIEW/observability-logs-preview.html"               "$OUT/observability-logs-preview-v34.html"
cp "$PREVIEW/observability-metrics-preview.html"            "$OUT/observability-metrics-preview-v34.html"
cp "$PREVIEW/observability-sli-slo-preview.html"            "$OUT/observability-sli-slo-preview-v34.html"
cp "$PREVIEW/observability-traces-preview.html"             "$OUT/observability-traces-preview-v34.html"

# Runbooks preview copies (v34)
cp "$PREVIEW/runbooks-incident-preview.html"               "$OUT/runbooks-incident-preview-v34.html"
cp "$PREVIEW/runbooks-migration-preview.html"              "$OUT/runbooks-migration-preview-v34.html"
cp "$PREVIEW/runbooks-rollback-preview.html"               "$OUT/runbooks-rollback-preview-v34.html"

# Checklists preview copies (v34)
cp "$PREVIEW/checklists-architecture-preview.html"        "$OUT/checklists-architecture-preview-v34.html"
cp "$PREVIEW/checklists-deployment-preview.html"          "$OUT/checklists-deployment-preview-v34.html"
cp "$PREVIEW/checklists-security-preview.html"            "$OUT/checklists-security-preview-v34.html"
...
cp "$PREVIEW/forty-six-emblems.html"                       "$OUT/forty-six-emblems-v34.html"
cp "$PREVIEW/patterns-data-preview.html"                  "$OUT/data-patterns-preview-v34.html"
cp "$PREVIEW/knowledge-graph-preview.html"                "$OUT/knowledge-graph-preview-v34.html"
cp "$PREVIEW/system-design-edge-ai-preview.html"          "$OUT/edge-ai-preview-v34.html"
cp "$PREVIEW/system-design-event-driven-preview.html"     "$OUT/event-driven-preview-v34.html"
cp "$PREVIEW/system-design-ha-dr-preview.html"            "$OUT/ha-dr-preview-v34.html"
cp "$PREVIEW/system-design-scalable-preview.html"         "$OUT/scalable-preview-v34.html"
cp "$PREVIEW/technology-ui-ux-cx-preview.html"            "$OUT/ui-ux-cx-preview-v34.html"
cp "$PREVIEW/technology-api-backend-preview.html"         "$OUT/api-backend-preview-v34.html"
cp "$PREVIEW/technology-databases-preview.html"           "$OUT/databases-preview-v34.html"
cp "$PREVIEW/technology-cloud-preview.html"               "$OUT/cloud-preview-v34.html"
cp "$PREVIEW/technology-devops-preview.html"              "$OUT/devops-preview-v34.html"
cp "$PREVIEW/technology-practice-circles-preview.html"    "$OUT/practice-circles-preview-v34.html"
cp "$PREVIEW/technology-engagement-models-preview.html"   "$OUT/engagement-models-preview-v34.html"
cp "$PREVIEW/security-application-security-preview.html"           "$OUT/application-security-preview-v34.html"
cp "$PREVIEW/security-authentication-authorization-preview.html"   "$OUT/authentication-authorization-preview-v34.html"
cp "$PREVIEW/security-cloud-security-preview.html"                 "$OUT/cloud-security-preview-v34.html"
cp "$PREVIEW/security-encryption-preview.html"                     "$OUT/encryption-preview-v34.html"
cp "$PREVIEW/security-vulnerability-management-preview.html"       "$OUT/vulnerability-management-preview-v34.html"
...
tar tzf "$OUT/ascendion-engineering-v34.tar.gz" | head -30
