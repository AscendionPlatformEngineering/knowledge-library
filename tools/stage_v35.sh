...
<h1>Fifty pages, fifty motion mechanics — Architecture Tooling group complete</h1>
...
# ─── v35 cleanup script (deletes orphan stub directories from user's repo) ───
cat > "$REPO/tools/CLEANUP_v35.sh" <<'CLEANUP_EOF'
#!/usr/bin/env bash
...
CLEANUP_EOF
chmod +x "$REPO/tools/CLEANUP_v35.sh"

tar czf "$OUT/ascendion-engineering-v35.tar.gz" \
    --exclude='.git' --exclude='node_modules' --exclude='*.pyc' \
    tools src content infra .github

# Also expose CLEANUP_v35.sh as a standalone output (user can run it before
# extracting the tarball, without having to extract the tarball first).
cp "$REPO/tools/CLEANUP_v35.sh" "$OUT/CLEANUP_v35.sh"

# AI-Native preview copies
cp "$PREVIEW/ai-native-architecture-preview.html" "$OUT/ai-native-architecture-preview-v35.html"
cp "$PREVIEW/ai-native-ethics-preview.html"       "$OUT/ai-native-ethics-preview-v35.html"
cp "$PREVIEW/ai-native-monitoring-preview.html"   "$OUT/ai-native-monitoring-preview-v35.html"
cp "$PREVIEW/ai-native-rag-preview.html"          "$OUT/ai-native-rag-preview-v35.html"
cp "$PREVIEW/ai-native-security-preview.html"     "$OUT/ai-native-security-preview-v35.html"

# Governance preview copies (v35)
cp "$PREVIEW/governance-checklists-preview.html"        "$OUT/governance-checklists-preview-v35.html"
cp "$PREVIEW/governance-review-templates-preview.html"  "$OUT/governance-review-templates-preview-v35.html"
cp "$PREVIEW/governance-roles-preview.html"             "$OUT/governance-roles-preview-v35.html"
cp "$PREVIEW/governance-scorecards-preview.html"        "$OUT/governance-scorecards-preview-v35.html"

# Observability preview copies (v35)
cp "$PREVIEW/observability-incident-response-preview.html"  "$OUT/observability-incident-response-preview-v35.html"
cp "$PREVIEW/observability-logs-preview.html"               "$OUT/observability-logs-preview-v35.html"
cp "$PREVIEW/observability-metrics-preview.html"            "$OUT/observability-metrics-preview-v35.html"
cp "$PREVIEW/observability-sli-slo-preview.html"            "$OUT/observability-sli-slo-preview-v35.html"
cp "$PREVIEW/observability-traces-preview.html"             "$OUT/observability-traces-preview-v35.html"

# Runbooks preview copies (v35)
cp "$PREVIEW/runbooks-incident-preview.html"               "$OUT/runbooks-incident-preview-v35.html"
cp "$PREVIEW/runbooks-migration-preview.html"              "$OUT/runbooks-migration-preview-v35.html"
cp "$PREVIEW/runbooks-rollback-preview.html"               "$OUT/runbooks-rollback-preview-v35.html"

# Checklists preview copies (v35)
cp "$PREVIEW/checklists-architecture-preview.html"        "$OUT/checklists-architecture-preview-v35.html"
cp "$PREVIEW/checklists-deployment-preview.html"          "$OUT/checklists-deployment-preview-v35.html"
cp "$PREVIEW/checklists-security-preview.html"            "$OUT/checklists-security-preview-v35.html"

# Tools preview copies (v35)
cp "$PREVIEW/tools-ai-agents-preview.html"                "$OUT/tools-ai-agents-preview-v35.html"
cp "$PREVIEW/tools-cli-preview.html"                      "$OUT/tools-cli-preview-v35.html"
cp "$PREVIEW/tools-scripts-preview.html"                  "$OUT/tools-scripts-preview-v35.html"
cp "$PREVIEW/tools-validators-preview.html"               "$OUT/tools-validators-preview-v35.html"
...
cp "$PREVIEW/fifty-emblems.html"                       "$OUT/fifty-emblems-v35.html"
cp "$PREVIEW/patterns-data-preview.html"                  "$OUT/data-patterns-preview-v35.html"
cp "$PREVIEW/knowledge-graph-preview.html"                "$OUT/knowledge-graph-preview-v35.html"
cp "$PREVIEW/system-design-edge-ai-preview.html"          "$OUT/edge-ai-preview-v35.html"
cp "$PREVIEW/system-design-event-driven-preview.html"     "$OUT/event-driven-preview-v35.html"
cp "$PREVIEW/system-design-ha-dr-preview.html"            "$OUT/ha-dr-preview-v35.html"
cp "$PREVIEW/system-design-scalable-preview.html"         "$OUT/scalable-preview-v35.html"
cp "$PREVIEW/technology-ui-ux-cx-preview.html"            "$OUT/ui-ux-cx-preview-v35.html"
cp "$PREVIEW/technology-api-backend-preview.html"         "$OUT/api-backend-preview-v35.html"
cp "$PREVIEW/technology-databases-preview.html"           "$OUT/databases-preview-v35.html"
cp "$PREVIEW/technology-cloud-preview.html"               "$OUT/cloud-preview-v35.html"
cp "$PREVIEW/technology-devops-preview.html"              "$OUT/devops-preview-v35.html"
cp "$PREVIEW/technology-practice-circles-preview.html"    "$OUT/practice-circles-preview-v35.html"
cp "$PREVIEW/technology-engagement-models-preview.html"   "$OUT/engagement-models-preview-v35.html"
cp "$PREVIEW/security-application-security-preview.html"           "$OUT/application-security-preview-v35.html"
cp "$PREVIEW/security-authentication-authorization-preview.html"   "$OUT/authentication-authorization-preview-v35.html"
cp "$PREVIEW/security-cloud-security-preview.html"                 "$OUT/cloud-security-preview-v35.html"
cp "$PREVIEW/security-encryption-preview.html"                     "$OUT/encryption-preview-v35.html"
cp "$PREVIEW/security-vulnerability-management-preview.html"       "$OUT/vulnerability-management-preview-v35.html"
...
tar tzf "$OUT/ascendion-engineering-v35.tar.gz" | head -30
