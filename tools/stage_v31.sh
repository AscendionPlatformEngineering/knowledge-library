...
cat > "$PREVIEW/thirtyfive-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Thirty-five pages, thirty-five motion mechanics — Governance group complete</h1>
...
add_card() {
  ...
  } >> "$PREVIEW/thirtyfive-emblems.html"
}
...
# ─── v31 cleanup script (deletes orphan stub directories from user's repo) ───
cat > "$REPO/tools/CLEANUP_v31.sh" <<'CLEANUP_EOF'
#!/usr/bin/env bash
...
CLEANUP_EOF
chmod +x "$REPO/tools/CLEANUP_v31.sh"

tar czf "$OUT/ascendion-engineering-v31.tar.gz" \
    --exclude='.git' --exclude='node_modules' --exclude='*.pyc' \
    tools src content infra .github

# Also expose CLEANUP_v31.sh as a standalone output (user can run it before
# extracting the tarball, without having to extract the tarball first).
cp "$REPO/tools/CLEANUP_v31.sh" "$OUT/CLEANUP_v31.sh"

# AI-Native preview copies
cp "$PREVIEW/ai-native-architecture-preview.html" "$OUT/ai-native-architecture-preview-v31.html"
cp "$PREVIEW/ai-native-ethics-preview.html"       "$OUT/ai-native-ethics-preview-v31.html"
cp "$PREVIEW/ai-native-monitoring-preview.html"   "$OUT/ai-native-monitoring-preview-v31.html"
cp "$PREVIEW/ai-native-rag-preview.html"          "$OUT/ai-native-rag-preview-v31.html"
cp "$PREVIEW/ai-native-security-preview.html"     "$OUT/ai-native-security-preview-v31.html"

# Governance preview copies (v31)
cp "$PREVIEW/governance-checklists-preview.html"        "$OUT/governance-checklists-preview-v31.html"
cp "$PREVIEW/governance-review-templates-preview.html"  "$OUT/governance-review-templates-preview-v31.html"
cp "$PREVIEW/governance-roles-preview.html"             "$OUT/governance-roles-preview-v31.html"
cp "$PREVIEW/governance-scorecards-preview.html"        "$OUT/governance-scorecards-preview-v31.html"
...
cp "$PREVIEW/thirtyfive-emblems.html"                       "$OUT/thirtyfive-emblems-v31.html"
cp "$PREVIEW/patterns-data-preview.html"                  "$OUT/data-patterns-preview-v31.html"
cp "$PREVIEW/knowledge-graph-preview.html"                "$OUT/knowledge-graph-preview-v31.html"
cp "$PREVIEW/system-design-edge-ai-preview.html"          "$OUT/edge-ai-preview-v31.html"
cp "$PREVIEW/system-design-event-driven-preview.html"     "$OUT/event-driven-preview-v31.html"
cp "$PREVIEW/system-design-ha-dr-preview.html"            "$OUT/ha-dr-preview-v31.html"
cp "$PREVIEW/system-design-scalable-preview.html"         "$OUT/scalable-preview-v31.html"
cp "$PREVIEW/technology-ui-ux-cx-preview.html"            "$OUT/ui-ux-cx-preview-v31.html"
cp "$PREVIEW/technology-api-backend-preview.html"         "$OUT/api-backend-preview-v31.html"
cp "$PREVIEW/technology-databases-preview.html"           "$OUT/databases-preview-v31.html"
cp "$PREVIEW/technology-cloud-preview.html"               "$OUT/cloud-preview-v31.html"
cp "$PREVIEW/technology-devops-preview.html"              "$OUT/devops-preview-v31.html"
cp "$PREVIEW/technology-practice-circles-preview.html"    "$OUT/practice-circles-preview-v31.html"
cp "$PREVIEW/technology-engagement-models-preview.html"   "$OUT/engagement-models-preview-v31.html"
cp "$PREVIEW/security-application-security-preview.html"           "$OUT/application-security-preview-v31.html"
cp "$PREVIEW/security-authentication-authorization-preview.html"   "$OUT/authentication-authorization-preview-v31.html"
cp "$PREVIEW/security-cloud-security-preview.html"                 "$OUT/cloud-security-preview-v31.html"
cp "$PREVIEW/security-encryption-preview.html"                     "$OUT/encryption-preview-v31.html"
cp "$PREVIEW/security-vulnerability-management-preview.html"       "$OUT/vulnerability-management-preview-v31.html"
...
tar tzf "$OUT/ascendion-engineering-v31.tar.gz" | head -30
