...
cat > "$PREVIEW/twentysix-emblems.html" <<'HTMLHEAD'
<!DOCTYPE html>
...
<h1>Twenty-six pages, twenty-six motion mechanics — Security group complete</h1>
...
add_card() {
  ...
  } >> "$PREVIEW/twentysix-emblems.html"
}
...
tar czf "$OUT/ascendion-engineering-v28.tar.gz" \
...
cp "$PREVIEW/twentysix-emblems.html"                       "$OUT/twentysix-emblems-v28.html"
cp "$PREVIEW/patterns-data-preview.html"                  "$OUT/data-patterns-preview-v28.html"
cp "$PREVIEW/knowledge-graph-preview.html"                "$OUT/knowledge-graph-preview-v28.html"
cp "$PREVIEW/system-design-edge-ai-preview.html"          "$OUT/edge-ai-preview-v28.html"
cp "$PREVIEW/system-design-event-driven-preview.html"     "$OUT/event-driven-preview-v28.html"
cp "$PREVIEW/system-design-ha-dr-preview.html"            "$OUT/ha-dr-preview-v28.html"
cp "$PREVIEW/system-design-scalable-preview.html"         "$OUT/scalable-preview-v28.html"
cp "$PREVIEW/technology-ui-ux-cx-preview.html"            "$OUT/ui-ux-cx-preview-v28.html"
cp "$PREVIEW/technology-api-backend-preview.html"         "$OUT/api-backend-preview-v28.html"
cp "$PREVIEW/technology-databases-preview.html"           "$OUT/databases-preview-v28.html"
cp "$PREVIEW/technology-cloud-preview.html"               "$OUT/cloud-preview-v28.html"
cp "$PREVIEW/technology-devops-preview.html"              "$OUT/devops-preview-v28.html"
cp "$PREVIEW/technology-practice-circles-preview.html"    "$OUT/practice-circles-preview-v28.html"
cp "$PREVIEW/technology-engagement-models-preview.html"   "$OUT/engagement-models-preview-v28.html"
cp "$PREVIEW/security-application-security-preview.html"           "$OUT/application-security-preview-v28.html"
cp "$PREVIEW/security-authentication-authorization-preview.html"   "$OUT/authentication-authorization-preview-v28.html"
cp "$PREVIEW/security-cloud-security-preview.html"                 "$OUT/cloud-security-preview-v28.html"
cp "$PREVIEW/security-encryption-preview.html"                     "$OUT/encryption-preview-v28.html"
cp "$PREVIEW/security-vulnerability-management-preview.html"       "$OUT/vulnerability-management-preview-v28.html"
...
tar tzf "$OUT/ascendion-engineering-v28.tar.gz" | head -30
